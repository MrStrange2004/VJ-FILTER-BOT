...
API_ID = int(environ.get('API_ID', '21781923'))
API_HASH = environ.get('API_HASH', 'c3ab0edd9dff3197d014cd5c64098bf4')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/gCe.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5370516281').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002388555583'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002359132366 -1002334057981 -1002269852465 -1002445665409 -1001903509999').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://factur59:UVGtAEXlN6AYLL46@cluster0.k6o7s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Cinegroup100')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/cinegroup1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/strangegroup1000') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/mrstrangetalk')
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'Speedlinkurl.com')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '01e9cebc773baebae24b601e656f6e40c587a555')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Mrstrangemovie/21')
